...
class TrafficMetricsCollector:
    ...
    def reset(self):
        ...
        # NEW: instantaneous metrics for RL reward
    ...
    def update_metrics(self, vehicles_info, current_phase, current_step,
        ...
        self.last_passed_this_step = passed_this_step  # NEW
        ...
        # NEW: instantaneous queue sum this step
        ...
        # NEW: current active vehicles this step
    ...
    def get_metrics(self):
        ...
        # NEW: instantaneous per-step info for RL
